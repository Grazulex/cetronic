...
class CreateCatalogueFemmeCommand extends AbstractCatalogueCommand
{
    protected $signature = 'app:create-catalogue-femme
    ...
    protected $description = 'Génère le catalogue pour les femmes (Ladies)';
