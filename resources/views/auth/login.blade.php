                ...
                <div class="offset-lg-3 col-lg-6 mb-3" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                    <div class="login">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="d-flex justify-content-center text-red-700" style="background: #fbece2;padding:15px">
                                {{ __('user.transfert') }}
                            </div>
                            <br/>
                            <!-- Email Address -->
                            <div>
                                ...
                                <input class="form-control login-form form-control" type="email"
                            ...
                            <div>
                                ...
                                <input class="form-control login-form form-control" type="password"
